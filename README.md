### Flask API for Neo4j Graph Database 
...
1. [Create Persons nodes by json file to Database](#Create-Persons-nodes-by-json-file-to-Database)
1. [Create a single Company node to Database](#Create-a-single-Company-node-to-Database)
1. [Create Company nodes by json file to Database](#Create-Company-nodes-by-json-file-to-Database)
1. [Define the relationship between Person and Company to Database](#Define-the-relationship-between-Person-and-Company-to-Database)
1. [Update the company information that in Database](#Update-the-company-information-that-in-Database)
1. [Delete the relationship existed in Database](#Delete-the-relationship-existed-in-Database)
...
## Create a single Person node to Database
...
## Create Persons nodes by json file to Database
...
## Create a single Company node to Database
...
## Create Company nodes by json file to Database
...
## Define the relationship between Person and Company to Database
...
## Update the company information that in Database
...
## Delete the relationship existed in Database
